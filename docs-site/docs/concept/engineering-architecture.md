...
- **`GET /v1/meta/parity-gaps`** — `schema: inquanto_gap_export_v1`: package version + `gaps` from `inquanto_gap_categories()` (dashboard / CI against [inquanto_public_parity_matrix.md](/product/roadmap)).
