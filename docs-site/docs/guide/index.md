...
按 **P1→P4** 读功能与用法；**总览前先读** [产品功能](/product/features)。**三条入门路径**见 [新用户三条路径](/guide/onboarding-three-paths)。上手见 [教程 · 快速开始](/tutorial/quickstart) 与 [工作流与 YAML](/tutorial/workflow-overview)，命令见 [命令行与脚本](/reference/cli-and-scripts)。边界与内部对标见 [定位与路线](/product/)；原理阅读见 [原理与阅读建议](/guide/principles-and-reading)。公开文档对照 [/mirror/](/mirror/)（可选）。

## 按角色入口（Choose your path）
...
| 柱 | 入口 |
|----|------|
| P1 化学与嵌入 | [化学与嵌入](/guide/chemistry-and-embedding/) |
| P2 算法与协议 | [算法与协议](/guide/algorithms-and-protocols/) |
| P3 执行与分析 | [执行与分析](/guide/execution-and-analysis/) |
| P4 作业与可复现 | [作业与可复现](/guide/jobs-and-reproducibility/) |
