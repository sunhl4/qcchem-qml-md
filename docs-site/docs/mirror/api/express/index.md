...
# inquanto.express <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto 镜像路径: <code>api / express</code> · <a href="/en/mirror/api/express/">English version</a></p>
...
- **里程碑**: —
- **InQuanto 锚点**: [https://docs.quantinuum.com/inquanto/api/inquanto/express.html](https://docs.quantinuum.com/inquanto/api/inquanto/express.html)
:::
