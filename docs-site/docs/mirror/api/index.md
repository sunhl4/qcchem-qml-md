...
# API 参考 <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">手册镜像节点路径: <code>api</code> · <a href="/en/mirror/api/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **参考文档 URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/](https://docs.quantinuum.com/inquanto/api/inquanto/)
:::
...
<MirrorBranch :prefix='["api"]' :grouped='true' locale="zh" />
