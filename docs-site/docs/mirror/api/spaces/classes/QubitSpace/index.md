...
<p class="mirror-breadcrumb">InQuanto 镜像路径: <code>api / spaces / classes / QubitSpace</code> · <a href="/en/mirror/api/spaces/classes/QubitSpace/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **InQuanto 锚点**: [https://docs.quantinuum.com/inquanto/api/inquanto/spaces.html#inquanto.spaces.QubitSpace](https://docs.quantinuum.com/inquanto/api/inquanto/spaces.html#inquanto.spaces.QubitSpace)
:::
