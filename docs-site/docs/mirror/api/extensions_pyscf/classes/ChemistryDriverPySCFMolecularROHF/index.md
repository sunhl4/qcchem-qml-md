...
qchem_module: ""
milestone: ""
i18n_key: api.extensions_pyscf.classes.ChemistryDriverPySCFMolecularROHF
---

# ChemistryDriverPySCFMolecularROHF <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto 镜像路径: <code>api / extensions_pyscf / classes / ChemistryDriverPySCFMolecularROHF</code> · <a href="/en/mirror/api/extensions_pyscf/classes/ChemistryDriverPySCFMolecularROHF/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **InQuanto 锚点**: [https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.ChemistryDriverPySCFMolecularROHF](https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.ChemistryDriverPySCFMolecularROHF)
:::
