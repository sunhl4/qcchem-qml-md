...
<p class="mirror-breadcrumb">手册镜像节点路径: <code>api / extensions_pyscf / classes / CASSCF</code> · <a href="/en/mirror/api/extensions_pyscf/classes/CASSCF/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **参考文档 URL**: [https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.CASSCF](https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.CASSCF)
:::
