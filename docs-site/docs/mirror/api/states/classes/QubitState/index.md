...
qchem_module: ""
milestone: ""
i18n_key: api.states.classes.QubitState
---

# QubitState <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto 镜像路径: <code>api / states / classes / QubitState</code> · <a href="/en/mirror/api/states/classes/QubitState/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **InQuanto 锚点**: [https://docs.quantinuum.com/inquanto/api/inquanto/states.html#inquanto.states.QubitState](https://docs.quantinuum.com/inquanto/api/inquanto/states.html#inquanto.states.QubitState)
:::
