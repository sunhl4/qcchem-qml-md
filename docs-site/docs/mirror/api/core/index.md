...
# inquanto.core <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto 镜像路径: <code>api / core</code> · <a href="/en/mirror/api/core/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **InQuanto 锚点**: [https://docs.quantinuum.com/inquanto/api/inquanto/core.html](https://docs.quantinuum.com/inquanto/api/inquanto/core.html)
:::
