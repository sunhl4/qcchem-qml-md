...
# 原子 computable <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto 镜像路径: <code>manual / computables / atomic</code> · <a href="/en/mirror/manual/computables/atomic/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **InQuanto 锚点**: [https://docs.quantinuum.com/inquanto/manual/computables/atomic.html](https://docs.quantinuum.com/inquanto/manual/computables/atomic.html)
:::
