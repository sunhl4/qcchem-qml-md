...
# 量子比特映射 <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">手册镜像节点路径: <code>manual / spaces_operators / qubit_mapping</code> · <a href="/en/mirror/manual/spaces_operators/qubit_mapping/">English version</a></p>
...
- **里程碑**: —
- **参考文档 URL**: [https://docs.quantinuum.com/inquanto/manual/spaces.html#qubit-mapping](https://docs.quantinuum.com/inquanto/manual/spaces.html#qubit-mapping)
:::
