...
qchem_module: ""
milestone: ""
i18n_key: manual.ansatze.ucc_family
---

# UCC 家族 <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto 镜像路径: <code>manual / ansatze / ucc_family</code> · <a href="/en/mirror/manual/ansatze/ucc_family/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **InQuanto 锚点**: [https://docs.quantinuum.com/inquanto/manual/ansatze/ucc_family.html](https://docs.quantinuum.com/inquanto/manual/ansatze/ucc_family.html)
:::
