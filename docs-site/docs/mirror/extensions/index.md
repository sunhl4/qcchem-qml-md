...
# 扩展 <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto 镜像路径: <code>extensions</code> · <a href="/en/mirror/extensions/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **InQuanto 锚点**: [https://docs.quantinuum.com/inquanto/extensions/extensions-overview.html](https://docs.quantinuum.com/inquanto/extensions/extensions-overview.html)
:::
...
<MirrorBranch :prefix='["extensions"]' :grouped='true' locale="zh" />
