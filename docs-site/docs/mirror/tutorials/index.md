...
# 教程 <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto 镜像路径: <code>tutorials</code> · <a href="/en/mirror/tutorials/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **InQuanto 锚点**: [https://docs.quantinuum.com/inquanto/tutorials/tutorial_overview.html](https://docs.quantinuum.com/inquanto/tutorials/tutorial_overview.html)
:::
...
<MirrorBranch :prefix='["tutorials"]' :grouped='true' locale="zh" />
