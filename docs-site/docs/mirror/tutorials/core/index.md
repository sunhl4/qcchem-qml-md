...
# 核心教程 <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto 镜像路径: <code>tutorials / core</code> · <a href="/en/mirror/tutorials/core/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **InQuanto 锚点**: [https://docs.quantinuum.com/inquanto/tutorials/tutorial_overview.html#core-tutorials](https://docs.quantinuum.com/inquanto/tutorials/tutorial_overview.html#core-tutorials)
:::
...
<MirrorBranch :prefix='["tutorials","core"]' :grouped='false' locale="zh" />
