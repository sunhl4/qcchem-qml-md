...
# 扩展 VQE <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto 镜像路径: <code>tutorials / core / extended_vqe</code> · <a href="/en/mirror/tutorials/core/extended_vqe/">English version</a></p>
...
- **对应模块**: *（占位，未实现 — 见里程碑）*
- **里程碑**: —
- **InQuanto 锚点**: [https://docs.quantinuum.com/inquanto/tutorials/InQ_tut_VQE_extended.html](https://docs.quantinuum.com/inquanto/tutorials/InQ_tut_VQE_extended.html)
:::
