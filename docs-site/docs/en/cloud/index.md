# Simulator cloud (skeleton)

Contract stubs for a **self-hosted** multi-tenant simulator story — not Nexus. Same shape as [Chinese `/cloud/`](/cloud/).

- [Tenant & quotas](/en/cloud/tenant-and-quotas)
