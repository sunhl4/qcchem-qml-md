...
qchem_module: ""
milestone: ""
i18n_key: manual.computables.atomic
---

# Atomic computables <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>manual / computables / atomic</code> · <a href="/mirror/manual/computables/atomic/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/manual/computables/atomic.html](https://docs.quantinuum.com/inquanto/manual/computables/atomic.html)
:::
