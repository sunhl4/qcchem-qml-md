...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>manual / computables / atomic</code> · <a href="/mirror/manual/computables/atomic/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/manual/computables/atomic.html](https://docs.quantinuum.com/inquanto/manual/computables/atomic.html)
:::
