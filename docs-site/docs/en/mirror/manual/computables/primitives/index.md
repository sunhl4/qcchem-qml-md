...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>manual / computables / primitives</code> · <a href="/mirror/manual/computables/primitives/">中文版</a></p>
...
- **Milestone**: Q4 2026
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/manual/computables/primitives.html](https://docs.quantinuum.com/inquanto/manual/computables/primitives.html)
:::
