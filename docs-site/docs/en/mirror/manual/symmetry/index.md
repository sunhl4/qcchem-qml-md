...
qchem_module: ""
milestone: Q3 2026
i18n_key: manual.symmetry
---

# Symmetry <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto mirror path: <code>manual / symmetry</code> · <a href="/mirror/manual/symmetry/">中文版</a></p>
...
- **Milestone**: Q3 2026
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/manual/symmetry.html](https://docs.quantinuum.com/inquanto/manual/symmetry.html)
:::
