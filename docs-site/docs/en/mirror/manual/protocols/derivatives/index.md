...
qchem_module: ""
milestone: Q3 2026
i18n_key: manual.protocols.derivatives
---

# Derivative protocols <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>manual / protocols / derivatives</code> · <a href="/mirror/manual/protocols/derivatives/">中文版</a></p>
...
- **Milestone**: Q3 2026
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/manual/protocols/derivative.html](https://docs.quantinuum.com/inquanto/manual/protocols/derivative.html)
:::
