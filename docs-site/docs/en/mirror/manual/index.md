...
# Manual <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>manual</code> · <a href="/mirror/manual/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/manual/](https://docs.quantinuum.com/inquanto/manual/)
:::
...
<MirrorBranch :prefix='["manual"]' :grouped='true' locale="en" />
