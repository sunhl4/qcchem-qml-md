---
title: Variational quantum deflation for excited states
...
milestone: ""
i18n_key: tutorials.core.vqd
---

# Variational quantum deflation for excited states <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto mirror path: <code>tutorials / core / vqd</code> · <a href="/mirror/tutorials/core/vqd/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/tutorials/InQ_tut_VQD.html](https://docs.quantinuum.com/inquanto/tutorials/InQ_tut_VQD.html)
:::
