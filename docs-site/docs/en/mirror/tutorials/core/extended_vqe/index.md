...
qchem_module: ""
milestone: ""
i18n_key: tutorials.core.extended_vqe
---

# Extended VQE <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>tutorials / core / extended_vqe</code> · <a href="/mirror/tutorials/core/extended_vqe/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/tutorials/InQ_tut_VQE_extended.html](https://docs.quantinuum.com/inquanto/tutorials/InQ_tut_VQE_extended.html)
:::
