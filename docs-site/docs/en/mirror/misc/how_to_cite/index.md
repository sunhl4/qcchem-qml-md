---
title: Citing upstream documentation (mirror)
...
qchem_module: ""
milestone: ""
i18n_key: misc.how_to_cite
---

# Citing upstream documentation (mirror) <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>misc / how_to_cite</code> · <a href="/mirror/misc/how_to_cite/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/misc/cite.html](https://docs.quantinuum.com/inquanto/misc/cite.html)
:::
