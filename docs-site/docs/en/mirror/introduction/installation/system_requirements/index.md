...
# System requirements <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>introduction / installation / system_requirements</code> · <a href="/mirror/introduction/installation/system_requirements/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/introduction/system_requirements.html](https://docs.quantinuum.com/inquanto/introduction/system_requirements.html)
:::
