...
# Introduction <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto mirror path: <code>introduction</code> · <a href="/mirror/introduction/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/introduction/](https://docs.quantinuum.com/inquanto/introduction/)
:::
...
<MirrorBranch :prefix='["introduction"]' :grouped='true' locale="en" />
