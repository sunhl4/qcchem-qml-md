...
qchem_module: ""
milestone: ""
i18n_key: api.spaces.classes.QubitSpace
---

# QubitSpace <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / spaces / classes / QubitSpace</code> · <a href="/mirror/api/spaces/classes/QubitSpace/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/spaces.html#inquanto.spaces.QubitSpace](https://docs.quantinuum.com/inquanto/api/inquanto/spaces.html#inquanto.spaces.QubitSpace)
:::
