...
qchem_module: ""
milestone: ""
i18n_key: api.spaces.classes.FermionSpace
---

# FermionSpace <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / spaces / classes / FermionSpace</code> · <a href="/mirror/api/spaces/classes/FermionSpace/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/spaces.html#inquanto.spaces.FermionSpace](https://docs.quantinuum.com/inquanto/api/inquanto/spaces.html#inquanto.spaces.FermionSpace)
:::
