---
title: Reference API · inquanto.embeddings
...
milestone: ""
i18n_key: api.embeddings
---

# Reference API · inquanto.embeddings <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / embeddings</code> · <a href="/mirror/api/embeddings/">中文版</a></p>

::: info Mirror metadata
- **Status**: Partial
- **Pillar**: P1 Chemistry & embedding
- **Diátaxis**: Reference
- **Module**: `qchem_stack.chem.embedding`
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/embeddings.html](https://docs.quantinuum.com/inquanto/api/inquanto/embeddings.html)
:::
...
**Partial** — Module: `qchem_stack.chem.embedding`
