---
title: Reference API · inquanto.mappings
...
qchem_module: ""
milestone: ""
i18n_key: api.mappings
---

# Reference API · inquanto.mappings <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / mappings</code> · <a href="/mirror/api/mappings/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/mappings.html](https://docs.quantinuum.com/inquanto/api/inquanto/mappings.html)
:::
...
<MirrorBranch :prefix='["api","mappings"]' :grouped='false' locale="en" />
