...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / mappings / classes / QubitMappingJordanWigner</code> · <a href="/mirror/api/mappings/classes/QubitMappingJordanWigner/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/mappings.html#inquanto.mappings.QubitMappingJordanWigner](https://docs.quantinuum.com/inquanto/api/inquanto/mappings.html#inquanto.mappings.QubitMappingJordanWigner)
:::
