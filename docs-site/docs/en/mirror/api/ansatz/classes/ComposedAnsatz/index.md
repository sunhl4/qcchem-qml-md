...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / ansatz / classes / ComposedAnsatz</code> · <a href="/mirror/api/ansatz/classes/ComposedAnsatz/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.ComposedAnsatz](https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.ComposedAnsatz)
:::
