...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / ansatz / classes / LayeredAnsatz</code> · <a href="/mirror/api/ansatz/classes/LayeredAnsatz/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.LayeredAnsatz](https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.LayeredAnsatz)
:::
