...
qchem_module: ""
milestone: ""
i18n_key: api.ansatz.classes.FermionSpaceStateExp
---

# FermionSpaceStateExp <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / ansatz / classes / FermionSpaceStateExp</code> · <a href="/mirror/api/ansatz/classes/FermionSpaceStateExp/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.FermionSpaceStateExp](https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.FermionSpaceStateExp)
:::
