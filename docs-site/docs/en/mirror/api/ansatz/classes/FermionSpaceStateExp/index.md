...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / ansatz / classes / FermionSpaceStateExp</code> · <a href="/mirror/api/ansatz/classes/FermionSpaceStateExp/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.FermionSpaceStateExp](https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.FermionSpaceStateExp)
:::
