...
qchem_module: ""
milestone: ""
i18n_key: api.ansatz.classes.GeneralAnsatz
---

# GeneralAnsatz <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / ansatz / classes / GeneralAnsatz</code> · <a href="/mirror/api/ansatz/classes/GeneralAnsatz/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.GeneralAnsatz](https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.GeneralAnsatz)
:::
