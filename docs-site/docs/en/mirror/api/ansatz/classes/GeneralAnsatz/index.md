...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / ansatz / classes / GeneralAnsatz</code> · <a href="/mirror/api/ansatz/classes/GeneralAnsatz/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.GeneralAnsatz](https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.GeneralAnsatz)
:::
