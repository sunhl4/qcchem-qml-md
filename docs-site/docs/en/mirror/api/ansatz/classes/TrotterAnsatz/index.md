...
qchem_module: ""
milestone: ""
i18n_key: api.ansatz.classes.TrotterAnsatz
---

# TrotterAnsatz <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / ansatz / classes / TrotterAnsatz</code> · <a href="/mirror/api/ansatz/classes/TrotterAnsatz/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.TrotterAnsatz](https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.TrotterAnsatz)
:::
