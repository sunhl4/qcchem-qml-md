...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / ansatz / classes / TrotterAnsatz</code> · <a href="/mirror/api/ansatz/classes/TrotterAnsatz/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.TrotterAnsatz](https://docs.quantinuum.com/inquanto/api/inquanto/ansatz.html#inquanto.ansatz.TrotterAnsatz)
:::
