...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / states / classes / QubitState</code> · <a href="/mirror/api/states/classes/QubitState/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/states.html#inquanto.states.QubitState](https://docs.quantinuum.com/inquanto/api/inquanto/states.html#inquanto.states.QubitState)
:::
