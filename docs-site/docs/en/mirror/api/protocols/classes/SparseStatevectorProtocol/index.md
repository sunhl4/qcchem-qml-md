...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / protocols / classes / SparseStatevectorProtocol</code> · <a href="/mirror/api/protocols/classes/SparseStatevectorProtocol/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/protocols.html#inquanto.protocols.SparseStatevectorProtocol](https://docs.quantinuum.com/inquanto/api/inquanto/protocols.html#inquanto.protocols.SparseStatevectorProtocol)
:::
