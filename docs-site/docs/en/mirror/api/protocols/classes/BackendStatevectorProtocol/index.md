---
title: BackendStatevectorProtocol
...
qchem_module: ""
milestone: ""
i18n_key: api.protocols.classes.BackendStatevectorProtocol
---

# BackendStatevectorProtocol <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / protocols / classes / BackendStatevectorProtocol</code> · <a href="/mirror/api/protocols/classes/BackendStatevectorProtocol/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/protocols.html#inquanto.protocols.BackendStatevectorProtocol](https://docs.quantinuum.com/inquanto/api/inquanto/protocols.html#inquanto.protocols.BackendStatevectorProtocol)
:::
