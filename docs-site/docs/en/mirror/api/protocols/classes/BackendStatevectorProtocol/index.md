...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / protocols / classes / BackendStatevectorProtocol</code> · <a href="/mirror/api/protocols/classes/BackendStatevectorProtocol/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/protocols.html#inquanto.protocols.BackendStatevectorProtocol](https://docs.quantinuum.com/inquanto/api/inquanto/protocols.html#inquanto.protocols.BackendStatevectorProtocol)
:::
