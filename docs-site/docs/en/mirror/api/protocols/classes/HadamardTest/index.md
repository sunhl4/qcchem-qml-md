...
qchem_module: ""
milestone: ""
i18n_key: api.protocols.classes.HadamardTest
---

# HadamardTest <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / protocols / classes / HadamardTest</code> · <a href="/mirror/api/protocols/classes/HadamardTest/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/protocols.html#inquanto.protocols.HadamardTest](https://docs.quantinuum.com/inquanto/api/inquanto/protocols.html#inquanto.protocols.HadamardTest)
:::
