...
qchem_module: ""
milestone: ""
i18n_key: api.protocols.classes.CombinedMitigation
---

# CombinedMitigation <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / protocols / classes / CombinedMitigation</code> · <a href="/mirror/api/protocols/classes/CombinedMitigation/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/protocols.html#inquanto.protocols.CombinedMitigation](https://docs.quantinuum.com/inquanto/api/inquanto/protocols.html#inquanto.protocols.CombinedMitigation)
:::
