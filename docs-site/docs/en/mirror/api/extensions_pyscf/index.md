---
title: inquanto.extensions.pyscf
...
milestone: ""
i18n_key: api.extensions_pyscf
---

# inquanto.extensions.pyscf <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / extensions_pyscf</code> · <a href="/mirror/api/extensions_pyscf/">中文版</a></p>

::: info Mirror metadata
- **Status**: Partial
- **Pillar**: P1 Chemistry & embedding
- **Diátaxis**: Reference
- **Module**: `qchem_stack.chem.drivers.pyscf_driver`
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html](https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html)
:::
...
**Partial** — Module: `qchem_stack.chem.drivers.pyscf_driver`
...
<MirrorBranch :prefix='["api","extensions_pyscf"]' :grouped='false' locale="en" />
