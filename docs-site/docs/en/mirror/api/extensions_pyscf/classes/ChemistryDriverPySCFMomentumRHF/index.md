---
title: ChemistryDriverPySCFMomentumRHF
...
qchem_module: ""
milestone: ""
i18n_key: api.extensions_pyscf.classes.ChemistryDriverPySCFMomentumRHF
---

# ChemistryDriverPySCFMomentumRHF <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / extensions_pyscf / classes / ChemistryDriverPySCFMomentumRHF</code> · <a href="/mirror/api/extensions_pyscf/classes/ChemistryDriverPySCFMomentumRHF/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.ChemistryDriverPySCFMomentumRHF](https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.ChemistryDriverPySCFMomentumRHF)
:::
