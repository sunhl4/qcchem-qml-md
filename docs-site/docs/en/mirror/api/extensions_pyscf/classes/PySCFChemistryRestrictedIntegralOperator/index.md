...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / extensions_pyscf / classes / PySCFChemistryRestrictedIntegralOperator</code> · <a href="/mirror/api/extensions_pyscf/classes/PySCFChemistryRestrictedIntegralOperator/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.PySCFChemistryRestrictedIntegralOperator](https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.PySCFChemistryRestrictedIntegralOperator)
:::
