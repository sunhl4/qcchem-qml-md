...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / extensions_pyscf / classes / DMETRHFFragmentPySCFActive</code> · <a href="/mirror/api/extensions_pyscf/classes/DMETRHFFragmentPySCFActive/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.DMETRHFFragmentPySCFActive](https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.DMETRHFFragmentPySCFActive)
:::
