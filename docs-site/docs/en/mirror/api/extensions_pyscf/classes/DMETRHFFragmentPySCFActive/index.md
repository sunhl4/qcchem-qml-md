---
title: DMETRHFFragmentPySCFActive
...
qchem_module: ""
milestone: ""
i18n_key: api.extensions_pyscf.classes.DMETRHFFragmentPySCFActive
---

# DMETRHFFragmentPySCFActive <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / extensions_pyscf / classes / DMETRHFFragmentPySCFActive</code> · <a href="/mirror/api/extensions_pyscf/classes/DMETRHFFragmentPySCFActive/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.DMETRHFFragmentPySCFActive](https://docs.quantinuum.com/inquanto/api/extensions/inquanto-pyscf_api.html#inquanto.extensions.pyscf.DMETRHFFragmentPySCFActive)
:::
