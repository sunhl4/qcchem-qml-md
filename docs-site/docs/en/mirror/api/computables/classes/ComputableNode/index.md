...
qchem_module: ""
milestone: ""
i18n_key: api.computables.classes.ComputableNode
---

# ComputableNode <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / computables / classes / ComputableNode</code> · <a href="/mirror/api/computables/classes/ComputableNode/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.ComputableNode](https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.ComputableNode)
:::
