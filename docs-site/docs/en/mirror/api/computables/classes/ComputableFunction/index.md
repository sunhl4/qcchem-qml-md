...
qchem_module: ""
milestone: ""
i18n_key: api.computables.classes.ComputableFunction
---

# ComputableFunction <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / computables / classes / ComputableFunction</code> · <a href="/mirror/api/computables/classes/ComputableFunction/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.ComputableFunction](https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.ComputableFunction)
:::
