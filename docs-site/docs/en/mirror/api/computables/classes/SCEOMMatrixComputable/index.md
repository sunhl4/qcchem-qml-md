...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / computables / classes / SCEOMMatrixComputable</code> · <a href="/mirror/api/computables/classes/SCEOMMatrixComputable/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.SCEOMMatrixComputable](https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.SCEOMMatrixComputable)
:::
