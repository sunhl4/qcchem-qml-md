...
qchem_module: ""
milestone: ""
i18n_key: api.computables.classes.SCEOMMatrixComputable
---

# SCEOMMatrixComputable <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / computables / classes / SCEOMMatrixComputable</code> · <a href="/mirror/api/computables/classes/SCEOMMatrixComputable/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.SCEOMMatrixComputable](https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.SCEOMMatrixComputable)
:::
