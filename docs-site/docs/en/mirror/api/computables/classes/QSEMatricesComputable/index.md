...
qchem_module: ""
milestone: ""
i18n_key: api.computables.classes.QSEMatricesComputable
---

# QSEMatricesComputable <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / computables / classes / QSEMatricesComputable</code> · <a href="/mirror/api/computables/classes/QSEMatricesComputable/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.QSEMatricesComputable](https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.QSEMatricesComputable)
:::
