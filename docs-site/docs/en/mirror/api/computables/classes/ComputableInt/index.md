...
qchem_module: ""
milestone: ""
i18n_key: api.computables.classes.ComputableInt
---

# ComputableInt <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / computables / classes / ComputableInt</code> · <a href="/mirror/api/computables/classes/ComputableInt/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.ComputableInt](https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.ComputableInt)
:::
