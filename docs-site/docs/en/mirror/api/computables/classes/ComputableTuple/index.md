...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / computables / classes / ComputableTuple</code> · <a href="/mirror/api/computables/classes/ComputableTuple/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.ComputableTuple](https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.ComputableTuple)
:::
