...
qchem_module: ""
milestone: ""
i18n_key: api.computables.classes.ExpectationValue
---

# ExpectationValue <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / computables / classes / ExpectationValue</code> · <a href="/mirror/api/computables/classes/ExpectationValue/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.ExpectationValue](https://docs.quantinuum.com/inquanto/api/inquanto/computables.html#inquanto.computables.ExpectationValue)
:::
