---
title: ChemistryRestrictedIntegralOperator
...
qchem_module: ""
milestone: ""
i18n_key: api.operators.classes.ChemistryRestrictedIntegralOperator
---

# ChemistryRestrictedIntegralOperator <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / operators / classes / ChemistryRestrictedIntegralOperator</code> · <a href="/mirror/api/operators/classes/ChemistryRestrictedIntegralOperator/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/operators.html#inquanto.operators.ChemistryRestrictedIntegralOperator](https://docs.quantinuum.com/inquanto/api/inquanto/operators.html#inquanto.operators.ChemistryRestrictedIntegralOperator)
:::
