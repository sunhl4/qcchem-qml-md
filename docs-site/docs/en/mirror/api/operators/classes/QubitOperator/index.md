...
<p class="mirror-breadcrumb">Manual mirror node path: <code>api / operators / classes / QubitOperator</code> · <a href="/mirror/api/operators/classes/QubitOperator/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/operators.html#inquanto.operators.QubitOperator](https://docs.quantinuum.com/inquanto/api/inquanto/operators.html#inquanto.operators.QubitOperator)
:::
