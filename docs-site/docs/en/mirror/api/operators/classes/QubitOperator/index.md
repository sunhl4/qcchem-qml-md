...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / operators / classes / QubitOperator</code> · <a href="/mirror/api/operators/classes/QubitOperator/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/operators.html#inquanto.operators.QubitOperator](https://docs.quantinuum.com/inquanto/api/inquanto/operators.html#inquanto.operators.QubitOperator)
:::
