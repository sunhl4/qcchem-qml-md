...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / minimizers / classes / MinimizerNFT</code> · <a href="/mirror/api/minimizers/classes/MinimizerNFT/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html#inquanto.minimizers.MinimizerNFT](https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html#inquanto.minimizers.MinimizerNFT)
:::
