...
qchem_module: ""
milestone: ""
i18n_key: api.minimizers.classes.MinimizerSGD
---

# MinimizerSGD <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / minimizers / classes / MinimizerSGD</code> · <a href="/mirror/api/minimizers/classes/MinimizerSGD/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html#inquanto.minimizers.MinimizerSGD](https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html#inquanto.minimizers.MinimizerSGD)
:::
