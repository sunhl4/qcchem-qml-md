...
<p class="mirror-breadcrumb">Manual mirror node path: <code>api / minimizers / classes / MinimizerScipy</code> · <a href="/mirror/api/minimizers/classes/MinimizerScipy/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html#inquanto.minimizers.MinimizerScipy](https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html#inquanto.minimizers.MinimizerScipy)
:::
