...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / minimizers / classes / MinimizerSPSA</code> · <a href="/mirror/api/minimizers/classes/MinimizerSPSA/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html#inquanto.minimizers.MinimizerSPSA](https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html#inquanto.minimizers.MinimizerSPSA)
:::
