---
title: Reference API · inquanto.minimizers
...
qchem_module: ""
milestone: ""
i18n_key: api.minimizers
---

# Reference API · inquanto.minimizers <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">Manual mirror node path: <code>api / minimizers</code> · <a href="/mirror/api/minimizers/">中文版</a></p>
...
- **Milestone**: —
- **Reference doc URL**: [https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html](https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html)
:::
...
<MirrorBranch :prefix='["api","minimizers"]' :grouped='false' locale="en" />
