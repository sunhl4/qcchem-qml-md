...
<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / minimizers</code> · <a href="/mirror/api/minimizers/">中文版</a></p>
...
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html](https://docs.quantinuum.com/inquanto/api/inquanto/minimizers.html)
:::
