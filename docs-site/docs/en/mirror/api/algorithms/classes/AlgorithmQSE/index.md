...
milestone: ""
i18n_key: api.algorithms.classes.AlgorithmQSE
---

# AlgorithmQSE <StatusBadge :status="$frontmatter.status" />

<p class="mirror-breadcrumb">InQuanto mirror path: <code>api / algorithms / classes / AlgorithmQSE</code> · <a href="/mirror/api/algorithms/classes/AlgorithmQSE/">中文版</a></p>

::: info Mirror metadata
- **Status**: Partial
- **Pillar**: P2 Algorithms & protocols
- **Diátaxis**: Reference
- **Module**: `qchem_stack.quantum.qse_transition`
- **Milestone**: —
- **InQuanto anchor**: [https://docs.quantinuum.com/inquanto/api/inquanto/algorithms.html#inquanto.algorithms.AlgorithmQSE](https://docs.quantinuum.com/inquanto/api/inquanto/algorithms.html#inquanto.algorithms.AlgorithmQSE)
:::
...
**Partial** — Module: `qchem_stack.quantum.qse_transition`
