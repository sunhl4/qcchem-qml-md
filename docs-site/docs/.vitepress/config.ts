...
/** Mirror routes — structural map from `mirror-doc-tree.yaml` (third-party public doc tree). */
const introductionNavZh = [
  { text: "概览（参考镜像）", link: "/mirror/introduction/overview/" },
...
const introductionNavEn = [
  { text: "Overview (reference mirror)", link: "/en/mirror/introduction/overview/" },
...
const manualMirrorNavZh = [
  { text: "参考手册 · 使用说明", link: "/mirror/manual/howto/" },
...
const manualMirrorNavEn = [
  { text: "Reference manual · How-to", link: "/en/mirror/manual/howto/" },
...
export default withMermaid(defineConfig({
  title: "qchem-stack",
  /**
   * Light docs chrome for readability.
   * For dark-only again: `appearance: "force-dark"` and tune `custom.css`.
   */
  appearance: "light",
  description:
    "qchem-stack documentation: product features, user interfaces, tutorials, guides, CLI and HTTP API.",
  cleanUrls: true,
  srcDir: ".",
  /**
  ...
  locales: {
    root: {
      ...
      description:
        "qchem-stack：产品功能与接口、教程与工作流 YAML、四柱指南与原理阅读。",
      themeConfig: {
        nav: [
          { text: "首页", link: "/" },
    ...
    en: {
      ...
      description:
        "qchem-stack: product features & interfaces, tutorials and workflow YAML, guides and principles.",
      themeConfig: {
        nav: [
          { text: "Home", link: "/en/" },
