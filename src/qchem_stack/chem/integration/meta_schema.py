"""Standard ``driver_meta`` schema fields for multi-backend classical chemistry.

Distinct from :mod:`qchem_stack.chem.bridges.driver_meta`, which provides shallow-copy
helpers for interchange payloads.
"""
