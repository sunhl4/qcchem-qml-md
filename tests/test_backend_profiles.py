...
def test_apply_uqc_cloud_profile() -> None:
    ...
    cfg, prof = apply_backend_profile_immutable(cfg, "uqc_cloud")
...
def test_apply_cirq_profile() -> None:
    ...
    cfg, prof = apply_backend_profile_immutable(cfg, "cirq")
...
def test_unknown_profile_raises() -> None:
    ...
    with pytest.raises(ValueError, match="Unknown backend profile"):
        apply_backend_profile_immutable(cfg, "not_a_backend")
