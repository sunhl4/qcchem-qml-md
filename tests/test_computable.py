...
from qchem_stack.config import MoleculeSpec, ActiveSpaceSpec, ExperimentConfig, QuantumSpec, load_experiment_config
from qchem_stack.protocols.computable import assert_computable_workflow_graph_roundtrip, list_computables_for_config
...
def test_computable_workflow_graph_roundtrip_example_configs() -> None:
    ...
    for rel in ("configs/example_h2.yaml", "configs/qpe_dual_track_demo.yaml"):
