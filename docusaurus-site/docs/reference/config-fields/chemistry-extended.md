---
title: chemistry_extended 配置字段
description: 溶剂、PBC、AVAS、CASSCF、benchmarks 与对称性扩展。
---
...
相关：[AVAS/CASSCF](/modules/chem/avas-casscf) · [Pre-quantum 矩阵](/reference/pre-quantum-yaml-matrix)（PBC 限制）。
