---
title: scf 配置字段
description: SCF driver（pyscf/psi4/precomputed）、method 与 bundle_path。
---
...
**详细说明：** [说明_scf配置.md](https://github.com/sunhl4/qcchem-qml-md/blob/main/docs/说明_scf配置.md)
...
组合限制见 [Pre-quantum YAML 矩阵](/reference/pre-quantum-yaml-matrix)。
