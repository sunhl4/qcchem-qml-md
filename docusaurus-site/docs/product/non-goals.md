---
title: 未承诺项
description: Nexus、HQC、cuTensorNet L0 等刻意排除边界，避免范围蔓延。
---
...
本地 **FastAPI + SQLite** 作业类比见仓库 `docs/launch_retrieve_nexus_analog.md` 与 [HTTP API 参考](../reference/http-api-sqlite-jobs)；语义参考，非 1:1 替代。
...
- **BK / SCBK UCCSD Trotter 电路**：保持 `n/a`（见 [UCCSD Trotter 导出](../tutorial/uccsd-trotter-export)）
