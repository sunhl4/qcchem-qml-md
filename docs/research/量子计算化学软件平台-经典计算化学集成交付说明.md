...
| 本仓测试 | `tests/chem/`、`tests/test_integral_openfermion_tangelo_recipe.py` |
...
| 项 | 交付 | 验收 |
|----|------|------|
| A1 | `run_classical_benchmarks` 统一接口 | hf/mp2/ccsd/casci 结构化返回 |
...
**证据**：`tests/chem/test_chem_integral_solver_tangelo_aliases.py`，`tests/test_integral_openfermion_tangelo_recipe.py`
...
| 15 | classical benchmarks | ● | ● | ◐ | ○ | ◐ | `run_classical_benchmarks` |
...
| OpenFermion 对齐 | `tests/test_integral_openfermion_tangelo_recipe.py` |
