...
**文档性质**：给维护者的**决策与同步清单**（非对外 API 合同正文）。合同细节见 [技术文档_HTTP_API与SQLite作业队列及可观测性契约.md](技术文档_HTTP_API与SQLite作业队列及可观测性契约.md) 与 [ENGINEERING_ARCHITECTURE.md](ENGINEERING_ARCHITECTURE.md) §8–10。
...
| [技术文档_HTTP_API与SQLite作业队列及可观测性契约.md](技术文档_HTTP_API与SQLite作业队列及可观测性契约.md) | 中文 **schema/端点/存储** 契约 |
