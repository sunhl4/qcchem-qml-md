...
| **`algorithms/uccsd_vqe.py`** + **`algorithms/uccsd_mapping.py`** | UCCSD 变分 ansatz 与 JW/BK 映射层 | `variational_branch`；`uccsd_algorithm_report_v1`；需 `pauli.use_protocol: false` |
