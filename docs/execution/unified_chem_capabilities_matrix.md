...
|---|---|---|
| Global active-space qubit Hamiltonian (`embedding.mode=none` baseline path) | `supports_restricted_active_space_qubit_hamiltonian` | `src/qchem_stack/chem/pre_quantum_build.py` (`build_pre_quantum_input_with_context`) |
...
| Projection fragment Mulliken Hamiltonian (`projection_quantum_hamiltonian=fragment_mulliken_mo`) | `supports_projection_fragment_mulliken_hamiltonian` | `src/qchem_stack/chem/pre_quantum_build.py` |
