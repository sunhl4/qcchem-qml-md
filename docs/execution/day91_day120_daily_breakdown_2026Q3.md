...
| Day92 | W1 字段草案 | `inquanto_contract.py`、`export_parity_criteria_table.py` | 字段命名草案与映射表 | 命名与现有 schema 不冲突 |
| Day93 | W1 contract 预接入 | `inquanto_contract.py` | run/export 预注册字段草案 | key 注册完整 |
...
| Day96 | W1 文档同步 | `docs/*`、`docs-site/*` | 键名口径同步说明 | docs/docs-site 同源 |
...
| Day113 | W7 索引规划 | docs-site/examples | 索引任务表 | 覆盖三路径 |
| Day114 | W7 文档更新 | docs-site guides | 更新记录 | 链接有效 |
| Day115 | W7 示例更新 | examples/README/索引 | 示例入口更新 | 新用户可跟跑 |
| Day116 | 双站一致性校验 | docs + docs-site | 校验记录 | 关键入口互链 |
